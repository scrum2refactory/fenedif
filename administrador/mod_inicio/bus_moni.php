...
linvestigacion.id_linvestigacion=agrupamientos.linvestigacion and agrupamientos.docente='$docente' LIMIT ".($pagina-1)*$noRegistros.",$noRegistros");
...
$sSQL = "SELECT count(*) FROM agrupamientos"; //Cuento el total de registros
				...
				echo "<font color=#000080 align='center'><b>Total registros: ".$totalRegistros."  , Pagina: </b></font>";
				...
				for($i=1; $i<$noPaginas+1; $i++)
				 { //Imprimo las páginas
        			...
        			echo "<font color=#FF0000><b>$i</b></font>"; //A la página actual no le pongo link
        					...
        					echo "<a href=\"bus_moni.php?busqueda=todos&pagina=".$i."\">  <font color=#000080><b>$i</b></font></a>";
						$vehiculo="";
				 }	
/////////////////// reporte ///////////////////////////////////////////////////////////////////////
echo '<table class="tablacentrada" id="tabla">';
		echo '<tr class="encab">';
		echo '<td><p class="centrado"><a href=../excel/proyectos_excel.php title="'.$id_excel.'"><img src="../imgs/excel_img.png" alt="'.$id_excel.'" /></a> 
		<a href="#" onclick="abregrafico(\'grafico_proyecto.php\')" title="'.$id_grafico.'"><img src="../imgs/grafico_img.png" alt="'.$id_grafico.'" /></a>
		<a href="#" onclick="abre_pdf(\'proyec_list.php\')" title="'.$id_pdf.'"><img src="../imgs/pdf.ico" alt="'.$id_pdf.'" /></a></p></td>';		
		echo '</tr>';
	echo '</table>';
...
?>	
					...
					<tr>
						...
						<td class="tdatos">TIPO PROYECTO</td>
						<td class="tdatos">ZONA</td>
						...
						<td class="tdatos">ESTADISTICO</td>
					</tr>
<?php	
		...
		$matriz_cindirectos[]=$registro_agrup['fondos'];
			...
			echo '<td><img src="../imgs/terminar.jpg"><td>';
				...
				echo '<span><a href="#" onclick="grafico_est(\'grafico_matri.php\',\''.$agrupc.'\')" title="'.$id_grafico.'"><img src="../imgs/grafico_img.png" alt="'.$id_grafico.'"/></a></span>';echo '&nbsp;';
