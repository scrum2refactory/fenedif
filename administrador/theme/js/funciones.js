function OnSelectionChange (select) 
 ...
 function valida_envia(){ 
   	//valido el nombre 
   	if (document.registro.objetivo.value.length==0){ 
      	 alert("Tiene que escribir su nombre") 
      	 document.registro.objetivo.focus() 
      	 return 0; 
   	}   
 function validar() {
...
function blacklist1(){
        ...
        var id="23";
        alert(id);
        $("#comandni_div").load("act_acti.php?number="+phone+"&id="+id,function() {
...
function miraAgrup0(agrupamiento){
	var act=$F('registro');
	var url="reg_activ.php";
	var pars = "p1="+agrupamiento+"&act_post="+act+"";
	var ajax = new Ajax.Request( url, {
				parameters: pars,
				method: "post",
				onComplete: procesaRespuestaDoc
