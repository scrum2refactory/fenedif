...
if ( file_exists($archivo))
{
	...
	$qry = "INSERT INTO convocatoria (conv_nombre,nombre_archivo,fecha,contenido,tamanio,tamanio_unidad, tipo ) VALUES
	('$txt_convocatoria','$nombre_archivo','$fecha_ini_ing','$contenido','{$tamanio[0]}','{$tamanio[1]}', '$tipo')";
