...
header("content-disposition: attachment;filename=list_tcapacitacion_fechas.xls");
?>
<HTML LANG="es">
...
$sql = "
SELECT tcursocf.*,tipocurso.tipo_descripcion,
...
LEFT JOIN
	...
	where tcursocf.fecha_inicio>='$ini' and tcursocf.fecha_inicio<='$fin'
";
...
$row["sucursal_nombre"],$row["lugar_imparticion"]
