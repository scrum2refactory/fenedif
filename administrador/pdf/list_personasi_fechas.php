...
header("content-disposition: attachment;filename=list_personai_fechas.xls");
?>
<HTML LANG="es">
...
WHERE 	tusuariocontratacion.`id_estadocontratacion`=1 and tusuariocontratacion.fecha_ingreso>='$ini' and tusuariocontratacion.fecha_ingreso<='$fin'
";
