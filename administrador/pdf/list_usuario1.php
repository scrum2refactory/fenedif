...
header("content-disposition: attachment;filename=list_usuario1.xls");
?>
<HTML LANG="es">
...
where 
tusuario.id_sucursal='$sucursal_id' || tusuario.estado='$estado' || tusuario.fecha_ingreso>='$ini' and tusuario.fecha_ingreso<='$fin '
";
