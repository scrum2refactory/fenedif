...
header("content-disposition: attachment;filename=list_usuariop_fechas.xls");
?>
<HTML LANG="es">
...
where 
tusuario.tusuario_id='2' and tusuario.fecha_ingreso>='$ini' and tusuario.fecha_ingreso<='$fin '
";
