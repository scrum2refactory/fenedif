...
//selecciono alumnos
$sel_alum = mysql_query("select * from alumnado ");
...
for($a=0;$a<$n;$a++)
	...
	$sel_cla = mysql_query("select clave from familias where codigo = '$codigo'");
	$reg_cla = mysql_fetch_array($sel_cla);
	$clave = $reg_cla['clave'];
...
//texto
$texto='
<p><b>Estimada familia:</b></p>
<p style="text-align:justify;">Para el presente curso académico 2008-2009, las profesoras Elena Díaz Pedroche, Esther Díaz Pedroche y Montse Díaz Pedroche ponen a su disposición la posibilidad de mantenerles informados sobre la marcha académica (calificaciones, faltas de asistencia, informes, boletines, etcétera) de sus hijos e hijas a través de Internet. Con ello, pretendemos ofrecerles información actualizada e instantánea sobre las actividades de sus hijos e hijas en nuestras clases. Además, gracias a este servicio, en cualquier momento podremos remitirles por correspondencia o en mano cualquier boletín o informe totalmente actualizado.</p>

<p>La dirección de Internet a la que deben dirigirse es: <b>http://siestta.org/siestta2/familias</b></p>
<p>Las claves personales que deben introducir para visualizar los datos de su hijo/a son:</p>
<ul>
<li>Número de familia: <b>'.$codigo.'</b></li>
<li>Clave de familia: <b>'.$clave.'</b></li>
</ul>

<p style="text-align:justify;">No obstante, para que esto sea posible, necesitamos su autorización por escrito para disponer de los siguientes datos de sus hijos e hijas:</p>
<ul>
...
<p style="text-align:justify;">Por tanto, les remitimos esta carta para que, si lo estiman oportuno, autoricen a que estos datos de sus hijos e hijas (más los académicos del curso 2008-2009 referentes a nuestras asignaturas) se hallen en nuestro registro, tal y como establece la Ley Orgánica 15/1999 de 13 de diciembre de Protección de Datos de Carácter Personal.</p>

<p><b>Autorización</b></p>
<p style="text-align:justify;">En conformidad con la Ley Orgánica 15/1999 de
13 de diciembre de
Protección de Datos de Carácter Personal (LOPD),
<b>'.$tutor1.'</b> <b>'.$tutor2.'</b> da/damos mi/nuestra conformidad para que los datos académicos de mi hijo/a correspondientes al curso académico 2008-2009 y a las materias de las profesoras Elena Díaz Pedroche, Esther Díaz Pedroche y Montse Díaz Pedroche figuren en un fichero automatizado (SIESTTA), el cual será procesado exclusivamente para las siguientes
...
para poder prestar el servicio requerido por el Usuario.</p>
      ...
      <p style="text-align:justify;">Los datos de carácter personal
...
han sido solicitados al Usuario.</p>
      <p style="text-align:justify;">El Usuario podrá ejercer sus derechos de
