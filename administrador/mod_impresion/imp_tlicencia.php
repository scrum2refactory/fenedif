...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TIPO LICENCIA");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tipolicencia_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE TIPO LICENCIA:");
	$camp_apellidop_value = $_POST["tipolicencia_nombre"];
