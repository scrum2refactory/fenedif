...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TIPO ACTIVIDAD");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tactividad_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE ACTIVIDAD:");
	$camp_apellidop_value = utf8_decode($_POST["tactividad_descripcion"]);
