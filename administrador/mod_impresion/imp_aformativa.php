...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("ÁREA FORMATIVA");
    $pdf->Cell(60, 10,$beg_bod,0, 0, 'C');
    $pdf->Ln();
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["areaformativa_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE ÁREA FORMATIVA:");
	$camp_apellidop_value = $_POST["areaformativa_nombre"];
