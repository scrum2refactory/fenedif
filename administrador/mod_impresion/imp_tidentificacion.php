...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TIPO IDENTIFICACIÓN");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tipoidentificacion_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE IDENTIFICACION:");
	$camp_apellidop_value = $_POST["tipoidentificacion_nombre"];
