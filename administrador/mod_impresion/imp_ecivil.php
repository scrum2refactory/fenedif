...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("ESTADO CIVIL");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["estadocivil_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE ESTADO CIVIL:");
	$camp_apellidop_value = $_POST["estadocivil_nombre"];
