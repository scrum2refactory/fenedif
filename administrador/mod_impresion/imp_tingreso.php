...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tipocontrato_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("TIPO CONTRATO:");
	$camp_apellidop_value = $_POST["tipocontrato_nombre"];
