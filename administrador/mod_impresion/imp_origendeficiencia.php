...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("ORIGEN DEFICIENCIA");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["origendeficiencia_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("ORIGEN DEFICIENCIA:");
	$camp_apellidop_value = $_POST["origendeficiencia_nombre"];
