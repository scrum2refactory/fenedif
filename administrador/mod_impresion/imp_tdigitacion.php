...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TIPO DIGITACIÓN");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tdigitacion_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE DIGITACIÓN:");
	$camp_apellidop_value = $_POST["tdigitacion_descripcion"];
