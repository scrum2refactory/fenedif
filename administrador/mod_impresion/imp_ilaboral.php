...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["intereslaboral_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("INTERÉS LABORAL:");
	$camp_apellidop_value = $_POST["intereslaboral_nombre"];
