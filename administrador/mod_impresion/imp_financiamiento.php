...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("FINANCIAMIENTO");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tfinanciamiento_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE FINANCIAMIENTO:");
	$camp_apellidop_value = $_POST["tfinanciamiento_descripcion"];
