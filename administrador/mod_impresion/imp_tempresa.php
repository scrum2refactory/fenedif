...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TIPO EMPRESA");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tipoempresa_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE TIPO EMPRESA:");
	$camp_apellidop_value = $_POST["tipoempresa_nombre"];
