...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("ESTADO DISCAPACIDAD");
    $pdf->Cell(50, 10,$beg_bod,0, 0, 'C');
    $pdf->Ln();
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["estadodiscapacidad_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("ESTADO DISCAPACIDAD:");
	$camp_apellidop_value = $_POST["estadodiscapacidad_nombre"];
