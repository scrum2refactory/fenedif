...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("FORMA ACCESO");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["formaacceso_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("FORMA ACCESO:");
	$camp_apellidop_value = $_POST["formaacceso_nombre"];
