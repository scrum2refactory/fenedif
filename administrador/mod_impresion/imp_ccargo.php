...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["categoriacargo_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE CARGO:");
	$camp_apellidop_value = $_POST["categoriacargo_nombre"];
