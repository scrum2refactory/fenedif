...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TIPO DOSCAPACIDAD");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tipodiscapacidad_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE DISCAPACIDAD:");
	$camp_apellidop_value = $_POST["tipodiscapacidad_nombre"];
