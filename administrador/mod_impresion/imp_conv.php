...
/***************  Header ***************************/
	$universidad=utf8_decode('CONVOCATORIA');
...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode('CONVOCATORIA');
...
/**************** Campo cedula ****************/	
	...
	$camp_ced = "CODIGO:";
	$camp_ced_value = $_POST["convocatoria_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "CONVOCATORIA:";
	$camp_apellidop_value = $_POST["convocatoria_nombre"];
