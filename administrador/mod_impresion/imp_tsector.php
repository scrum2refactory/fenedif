...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TIPO SECTOR");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tipoparroquia_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE TIPO SECTOR:");
	$camp_apellidop_value = $_POST["tipoparroquia_nombre"];
