...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TRATAMIENTO");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tratamiento_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE TRATAMIENTO:");
	$camp_apellidop_value = $_POST["tratamiento_nombre"];
