...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("PARENTESCO");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tqgarante_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE PARENTESCO:");
	$camp_apellidop_value = $_POST["tqgarante_descripcion"];
