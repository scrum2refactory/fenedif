...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode('TIPO DE TÉCNICO');
...
/**************** Campo cedula ****************/	
	...
	$camp_ced = "CODIGO:";
	$camp_ced_value = $_POST["ttecnico_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "NOMBRE TIPO TECNICO:";
	$camp_apellidop_value = $_POST["ttecnico_nombre"];
...
/************* Footer ************************/	
    $pdf->SetFont('Arial','B',10);
    $pdf->Cell(50, 30,"JEFE DE BRIGADA.",0,0,'C');
