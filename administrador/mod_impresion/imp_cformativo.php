...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("CENTRO FORMATIVO");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tipocformativo_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("CENTRO FORMATIVO:");
	$camp_apellidop_value = $_POST["tipocformativo_nombre"];
