...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TIPO SEGURO");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["tiposeguro_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE TIPO SEGURO:");
	$camp_apellidop_value = $_POST["tiposeguro_nombre"];
