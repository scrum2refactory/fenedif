...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("AYUDAS TÉCNICAS");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["ayudastecnicas_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("AYUDAS TÉCNICAS:");
	$camp_apellidop_value = $_POST["ayudastecnicas_nombre"];
