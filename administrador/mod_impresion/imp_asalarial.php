...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("A. SALARIAL");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["aspiracionsalarial_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("ASPIRACIÓN SALARIAL:");
	$camp_apellidop_value = $_POST["aspiracionsalarial_nombre"];
