...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("FORMA CONOCER");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["formaconocer_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE FORMA CONOCER:");
	$camp_apellidop_value = $_POST["formaconocer_nombre"];
