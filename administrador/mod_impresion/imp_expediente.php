...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode('EXPEDIENTE');
...
/**************** Campo cedula ****************/	
	...
	$camp_ced = "CODIGO:";
	$camp_ced_value = $_POST["expediente_id"];
...
/**************** CEDULA ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "CEDULA:";
	$camp_apellidop_value = $_POST["expediente_cedula"];
...
/**************** CANTON ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "CANTON:";
	$camp_apellidop_value = $_POST["canton"];
	$pdf->Cell(50, 8,$camp_apellidop,1);
	$pdf->SetFont("Times");
	$pdf->Cell(140, 8,$camp_apellidop_value,1);
	$pdf->Ln();	
/**************** PARROQUIA ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "PARROQUIA:";
	$camp_apellidop_value = $_POST["parroquia"];
	$pdf->Cell(50, 8,$camp_apellidop,1);
	$pdf->SetFont("Times");
	$pdf->Cell(140, 8,$camp_apellidop_value,1);
	$pdf->Ln();		
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "BENEFICIARIO:";
	$camp_apellidop_value = $_POST["expediente_nombre"];
	$pdf->Cell(50, 8,$camp_apellidop,1);
	$pdf->SetFont("Times");
	$pdf->Cell(140, 8,$camp_apellidop_value,1);
	$pdf->Ln();
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "RESPONSABLE BRIGADA:";
...
/**************** APELLIDOS ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "FECHA INICIO:";
	$camp_apellidop_value = $_POST["inicio"];
	$pdf->Cell(50, 8,$camp_apellidop,1);
	$pdf->SetFont("Times");
	$pdf->Cell(140, 8,$camp_apellidop_value,1);
	$pdf->Ln();
/**************** APELLIDOS ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = "FECHA FIN:";
	$camp_apellidop_value = $_POST["fin"];
	$pdf->Cell(50, 8,$camp_apellidop,1);
	$pdf->SetFont("Times");
	$pdf->Cell(140, 8,$camp_apellidop_value,1);
	$pdf->Ln();	
