...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("TEMPERATURA");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["temperatura_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE TEMPERATURA:");
	$camp_apellidop_value = $_POST["temperatura_nombre"];
