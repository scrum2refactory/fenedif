...
/*************** Cuerpo del documento **************/
    $beg_bod = utf8_decode("ADAPTACIÓN");
...
/**************** Campo cedula ****************/
	...
	$camp_ced_value = $_POST["adaptacion_id"];
...
/**************** Campo apellido paterno ****************/	
    $pdf->SetFont('Arial','B',10);
	$camp_apellidop = utf8_decode("NOMBRE ADAPTACIÓN:");
	$camp_apellidop_value = $_POST["adaptacion_nombre"];
