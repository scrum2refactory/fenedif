...
//////////////////////////observaciond //////////////////////////////////////////////////////////////
 ...
 ////////////////////////////////////////////////////////////////////////////
                            ...
                            $(document).ready(function(){
                                    ...
                                    $(\'#frmcformativo\').validate({
                                            ...
                                            messages:{
                                                ...
                                                lsSucursal: { required: "<span class=\'resultadoincorrecto\'><br>* Requerido</span>"},
                        ...
                        <table width="100%" border="0" align="center" cellpadding="1">
                            ...
                            <tr class="formulariofila1">
                                 <td  align="right"><b>Nº Estudiantes:</b></td>
                                	<td align="left">
                                    <input class="textbox" id="strNestudiantes" name="strNestudiantes" type="text" maxlength="50" '. JS_ONLY_NUMS .' value="'. $this->getStrNestudiantes() .'" />
                                </td>
                             	<td  align="right"><b>Nº Estudiantes Discapacidad:</b></td>
                                <td align="left">
                                    <input class="textbox" id="strNestudiantesd" name="strNestudiantesd" type="text" maxlength="9" '. JS_ONLY_NUMS .' value="'. $this->getStrNestudiantesd() .'" />
                                </td>
                            </tr>
                            <tr class="formulariofila1">
  ...
  <table width="100%" border="0" align="center" cellpadding="1">
                            <tr>
                                <td colspan="4" align="center" class="tablatitulo">Direccion del Centro Formativo</td>
                            </tr>
                            ...
                            <tr class="formulariofila1">
                                 <td  align="right"><b>Manzana:</b></td>
                                	<td align="left">
                                    <input class="textbox" id="strManzana" name="strManzana" type="text" maxlength="100" '. JS_ONLY_NUMS .' value="'. $this->getStrManzana() .'" />
                                </td>
                             	<td  align="right"><b>Solar:</b></td>
                                <td align="left">
                                    <input class="textbox" id="strSolar" name="strSolar" type="text" maxlength="100" '. JS_ONLY_NUMS .' value="'. $this->getStrSolar() .'" />
                                </td>
                            </tr>
                            <tr class="formulariofila1">
 ...
 public function getStrEliminar() 
	...
	public function getStrBuscarr() {
            ...
            $ProcedimientoAlmacenado = sprintf("CALL spbidentificadortemp('%d');","$cf");
			$query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
       ...
       public function getStrListar()
        {
            ...
            $ProcedimientoAlmacenado = sprintf("CALL sptotaltempresa('%d');", $sucursal);
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
            ...
            //Nombre Procedimientos Almacenados
			 ...
			 $cf=$_SESSION["usuario"]["suc"];
            $ProcedimientoAlmacenado = sprintf("CALL splistartempresa('%d','%d','%d');","$re", "$pa","$cf");
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
            $resultado = $query->getStrSqlSelect();
            ...
            $retval .= '
                        <table border="0" width="100%" cellpadding="1" cellspacing="1" align="center">
                            <tr>
                                <td colspan="17" align="center"><div class="vtip" title="Ingreso<br> [Nuevo Centro Fromativo]">
                                    
                                </div><td>
                            </tr>';
                            $paginacion->setStrNombrePagina("tempresa/tempresa.php");
            				$retval .= '<tr><td colspan="12" align="center">'. $paginacion->getStrPaginacion() .'</td></tr>
                            <tr class="tablatitulo">
                                <th colspan="17">LISTADO&nbsp;DE&nbsp;EMPRESAS&nbsp;REGISTRADAS</th>
                            </tr>
                            <tr class="tablasubtitulo">
                                <th>...</th>  
                                <th align="center"> </th>                                                              
                                <th align="center">Empresa</th>
                                <th align="center">Número de Empleados</th>
                                <th align="center">Número Empleados Discapacidad</th>
                                <th align="center">Sítio</th>
                                <th align="center">Puestos</th>
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. CFORMATIVO_URL .'cformativo.php">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" /> Regresar Listado Centro Formativo|</a>
                                    <td>
                                </tr>
                                ';
