 ...
 ///////////////////////////Lectura/////////////////////////////////////////////////
        ...
        public function getStrFormulario()
        {
         ...
         $retval  = '<script type="text/JavaScript" src="' . HOST .NAME. '/jquery/jquery.validate.js"></script>
                            ...
                            $(document).ready(function(){
								  ...
								  $("#lsTfnecesaria").change(function () {
                                    $("#lsTfnecesaria option:selected").each(function () {
                                            ...
                                            $.post( "'. FORMACIONS_URL .'formacions.php", { btnBuscar: "nivel",
								 ...
								 $("#lsTfnecesaria").change(function () {
                                    $("#lsTfnecesaria option:selected").each(function () {
                                            var tfnecesaria = $(this).val();
                                            $.post( "'. FORMACIONS_URL .'formacions.php", { btnBuscar: "niveledu",
                                                    strCodigotfnecesaria: tfnecesaria
                                                                                    },
                                        function(data){
            ...
            $retval .= '<form id="frmformacions" action="'. FORMACIONS_URL.'formacions.php" method="POST">';

            $Regresar = "regresar('". FORMACIONA_URL . "formacions.php')";
  ...
  public function getStrListar()
        {
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .=  '<a href="'.FORMACIONS_URL.'formacions.php?btnActualizar=Actualizar&strCodigo='. $rst["tformacionu_id"] .'"><img src="'. IMAGENES_PATH .'/actualizar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="ELIMINAR ÁREA FORMATIVA  <br> [codigo = '.$rst["tformacionu_id"] .' ]">';
                    $retval .=  '<a href="'.FORMACIONS_URL.'formacions.php?btnEliminar=Eliminar&strCodigo='. $rst["tformacionu_id"] .'" onclick="return confirmar()"><img src="'. IMAGENES_PATH .'/eliminar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="DETALLE ÁREA FORMATIVA <br> [ codigo = '.$rst["tformacionu_id"] .' ]">';
                    $retval .=  '<a href="'.FORMACIONS_URL.'formacions.php?btnDetalle=Detalle&strCodigo='. $rst["tformacionu_id"] .'"><img src="'. IMAGENES_PATH .'/detalle.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= '</tr>';
                    $i = 1 - $i;
                endforeach;
            ...
            $paginacion->setStrNombrePagina("formacions/formacions.php");
...
public function getStrListarcinformaticos()
        {
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .=  '<a href="'.FORMACIONS_URL.'formacions.php?btnEliminar=Eliminarcinformaticos&strCodigo='. $rst["tformacionucinf_id"] .'" onclick="return confirmar()"><img src="'. IMAGENES_PATH .'/eliminar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. FORMACIONS_URL .'formacions.php">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" />REGRESAR LISTADO ÁREA FORMATIVA |</a>
                                    <td>
                                </tr>
                                ';
