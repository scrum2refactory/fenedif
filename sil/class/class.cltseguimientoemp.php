 ...
 ////////////////////////////////////////////////////////////////////////////
        ...
        public function getStrFormulario()
        {
          ...
          $retval  = '<script type="text/JavaScript" src="' . HOST .NAME. '/jquery/jquery.validate.js"></script>
            ...
            $retval .= '<form id="frmtseguimientocf" action="'. TSEGUIMIENTOEMP_URL .'tseguimientoemp.php" method="POST">';
        ...
        public function getStrIngresar() {
            ...
            $ProcedimientoAlmacenado = sprintf("CALL spingresartseguimientoemp('%s', '%s', '%s', '%s');",
            ...
            if($query->getStrSqlInsertUpdateDelete()){
                ...
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s', '%s', '%s', '%s');", $_SESSION["usuario"]["cuenta"], 'G', 'tseguimientoemp', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
	...
	public function getStrActualizar() {
            ...
            $resultado = false;
            //Nombre Procedimientos Almacenados
           $ProcedimientoAlmacenado = sprintf("CALL spactualizartseguimientoemp('%s', '%s', '%s', '%s');",
 ...
 public function getStrEliminar() 
        {
            ...
            $resultado = false;
            //Nombre Procedimientos Almacenados
            $ProcedimientoAlmacenado = sprintf("CALL speliminartseguimientoemp('%s');", $this->getStrCodigo());
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
 	...
 	public function getStrBuscar() 
 	{
            ...
            $resultado = false;
            //Nombre Procedimientos Almacenados
            $ProcedimientoAlmacenado = sprintf("CALL spbtseguimientoemp('%s');", $this->getStrCodigo());
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
            ...
            if( count($resultado) > 0 )
            {
                foreach( $resultado as $rst): 
					$this->setStrCodigo($rst['id_seguimientoemp']);  
       ...
       public function getStrListar()
        {
            ...
            //Nombre Procedimientos Almacenados
            $ProcedimientoAlmacenado = sprintf("CALL sptotaltseguimientoemp();", $this->getStrCodigo());
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
            ...
            $ProcedimientoAlmacenado = sprintf("CALL splistartseguimientoemp('%d','%d','%d');","$re", "$pa","$cf");
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
            $resultado = $query->getStrSqlSelect();
            ...
            $retval .= '
                        <table border="0" width="100%" cellpadding="1" cellspacing="1" align="center">
                            <tr class="tablatitulo">
                                <th colspan="13">LISTADO SEGUIMIENTO EMPRESA</th>
                            </tr>
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= 	'<td align="center">'. $rst["id_seguimientoemp"] .'</td>';
					...
					$retval .= 	'<td align="left">'. $rst["nombre"] .'</td>';
 					$retval .= 	'<td align="center"><div class="vtip" title="Actualizar <br> [ codigo = '.$rst["id_seguimientoemp"] .' ]">';
                    $retval .=  '<a href="'.TSEGUIMIENTOEMP_URL.'tseguimientoemp.php?btnActualizar=Actualizar&strCodigo='. $rst["id_seguimientoemp"] .'"><img src="'. IMAGENES_PATH .'/actualizar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="Eliminar <br> [codigo = '.$rst["id_seguimientoemp"] .' ]">';
                    $retval .=  '<a href="'.TSEGUIMIENTOEMP_URL.'tseguimientoemp.php?btnEliminar=Eliminar&strCodigo='. $rst["id_seguimientoemp"] .'" onclick="return confirmar()"><img src="'. IMAGENES_PATH .'/eliminar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="Detalle Cursos <br> [ codigo = '.$rst["id_seguimientoemp"] .' ]">';
                    $retval .=  '<a href="'.TSEGUIMIENTOEMP_URL.'tseguimientoemp.php?btnDetalle=Detalle&strCodigo='. $rst["id_seguimientoemp"] .'"><img src="'. IMAGENES_PATH .'/detalle.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= '</tr>';
                    $i = 1 - $i;
                endforeach;
            ...
            $paginacion->setStrNombrePagina("tseguimientoemp/tseguimientoemp.php");
...
public function getStrDetallePersona()
        {
            $query = new clQuery();
            //Nombre Procedimientos Almacenados
            $ProcedimientoAlmacenado = sprintf("CALL spbdetalletseguimientoemp('%s');", $this->getStrCodigo());
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
            $resultado = $query->getStrSqlSelect();
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. TEMPRESA_URL .'tempresa.php">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" /> Regresar Listado Empresas|</a>
                                    <td>
                                </tr>
                                ';
                    ...
                    $retval .= '<tr class="listadofila0">
                                    ...
                                    <td align="left">  '. $rst["id_seguimientoemp"] .'</td>
                                </tr>
                                ';
                    $retval .= '<tr class="listadofila0">
