...
////////////////////////////////////////////////////////////////////
		...
		$thorario= new clThorario();
          ...
          $retval  = '<script type="text/JavaScript" src="' . HOST .NAME. '/jquery/jquery.validate.js"></script>
            ...
            $retval .= '<form id="frmayudast" action="'. AYUDAST_URL.'ayudast.php" method="POST">';

           $Regresar = "regresar('". AYUDAST_URL. "ayudast.php')";
        ...
        public function getStrIngresar() {
            ...
            if($query->getStrSqlInsertUpdateDelete()){
                ...
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s', '%s', '%s', '%s');", $_SESSION["usuario"]["cuenta"], 'G', 'ayudast', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
       ...
       public function getStrListar()
        {
            ...
            $retval .= '<legend class="etiquetaborde">
                            Forma de Ayudas Técnicas<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;"> Listado Forma de Ayudas Técnicas</legend>
                       ';
            $retval .= '
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= 	'<td align="center"><div class="vtip" title="Actualizar <br> [ codigo = '.$rst["ayudast_id"] .' ]">';
                    $retval .=  '<a href="'. AYUDAST_URL .'ayudast.php?btnActualizar=Actualizar&strCodigo='. $rst["ayudast_id"] .'"><img src="'. IMAGENES_PATH .'/actualizar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="Eliminar <br> [codigo = '.$rst["ayudast_id"] .' ]">';
                    $retval .=  '<a href="'.  AYUDAST_URL .'ayudast.php?btnEliminar=Eliminar&strCodigo='. $rst["ayudast_id"] .'" onclick="return confirmar()"><img src="'. IMAGENES_PATH .'/eliminar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="Detalle Centro Formativo <br> [ codigo = '.$rst["ayudast_id"] .' ]">';
                    $retval .=  '<a href="'.  AYUDAST_URL .'ayudast.php?btnDetalle=Detalle&strCodigo='. $rst["ayudast_id"] .'"><img src="'. IMAGENES_PATH .'/detalle.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= '</tr>';
                    $i = 1 - $i;
                endforeach;
            ...
            $paginacion->setStrNombrePagina("ayudast/ayudast.php");
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. AYUDAST_URL.'ayudast.php?btnNuevo=Nuevo&strCodigo='.$v.'">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" /> Regresar Listado Ayudas Técnicas|</a>
                                    <td>
                                </tr>
                                ';
