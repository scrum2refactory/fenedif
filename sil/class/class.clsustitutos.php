...
//////////////////////////////////////////////////////////////////////
        ...
        {            
          ...
          $retval  = '<script type="text/JavaScript" src="' . HOST .NAME. '/jquery/jquery.validate.js"></script>
                        ...
                        <script>
                            $(document).ready(function(){
                                    ...
                                    $("#lsProvincia option:selected").each(function () {
                                            ...
                                            $.post( "'. SUSTITUTOS_URL .'sustitutos.php", { btnBuscar: "Canton",
                                    ...
                                    $("#lsCanton option:selected").each(function () {
                                            var canton = $(this).val();
                                            $.post( "'. SUSTITUTOS_URL .'sustitutos.php", { btnBuscar: "Parroquia",
            ...
            $retval .= '<form id="frmsustitutos" action="'. SUSTITUTOS_URL .'sustitutos.php" method="POST">';

            $Regresar = "regresar('". SUSTITUTOS_URL . "sustitutos.php')";

            $retval .= '<fieldset class="fieldsetPequeno">';
            $retval .= '<legend class="etiquetaborde">
                            SUSTITUTOS <img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">LISTADO SUSTITUTOS<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;"> '. $this->getStrEtiqueta() .'
                          </legend>
                       ';
            $NHC = "";		   
            $retval .= '
                        <table width="100%" border="0" align="center" cellpadding="1">
                            ...
                            <tr class="formulariofila1">
                                ...
                                <td align="left">
                             	...
                             	<td align="right"><b>Persona con Discapacidad:&nbsp;</b></td>
	                             	<td align="left">                                    
	                                    <select name="StrNcarne" id="StrNcarne"  class="combobox">
	                                        '. $ncane->getStrListar($this->getStrNcarne()) .'
	                                    </select>
                                </td> 
  ...
  <table width="100%" border="0" align="center" cellpadding="1">
                            <tr>
                                <td colspan="4" align="center" class="tablatitulo">DIRECCIÓN DEL CIUDADANO</td>
                            </tr>
...
<table width="100%" border="0" align="center" cellpadding="1">
                            ...
                            <tr class="formulariofila1">
                                ...
                                <td align="left">
                             	...
                             	<td  align="right"><b>¿Tipo de Federación?:&nbsp;</b></td>
                                <td align="left">
        ...
        public function getStrIngresar() 
        {
            ...
            if($query->getStrSqlInsertUpdateDelete()){
                ...
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s','%s','%s','%s');", $_SESSION["usuario"]["cuenta"], 'G', 'sustitutos', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
 ...
 public function getStrEliminar() 
        {
            ...
            $resultado = false;
            //Nombre Procedimientos Almacenados
            $ProcedimientoAlmacenado = sprintf("CALL speliminarsustitutos('%s');", $this->getStrCodigo());
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
	...
	public function getStrBuscarr() 
		{
            ...
            $ProcedimientoAlmacenado = sprintf("CALL spbidentificadorsust('%d','%d');","$cf","$me");
			$query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
       ...
       public function getStrListar()
        {
            ...
            $retval .= '<legend class="etiquetaborde">
                            SUSTITUTOS<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">LISTADO SUSTITUTOS</legend>
                       ';
            $retval .= '
                        <table border="0" width="100%" cellpadding="1" cellspacing="1" align="center">
                            <tr>
                                <td colspan="14" align="center"><div class="vtip" title="Ingreso<br> [NUEVO SUSTITUTO]">
                                    <a href="'.SUSTITUTOS_URL.'sustitutos.php?btnNuevo=Nuevo">| <img src="'. IMAGENES_PATH .'/rptstocksucursal.png" title="" width="16px" height="16px"  border="0" /><img src="'. IMAGENES_PATH .'/nuevo.png" title="" width="16px" height="16px"  border="0" />NUEVO SUSTITUTO|</a>
                                </div><td>
                            </tr>';
                            $paginacion->setStrNombrePagina("sustitutos/sustitutos.php");
            				$retval .= '<tr><td colspan="12" align="center">'. $paginacion->getStrPaginacion() .'</td></tr>
                            <tr class="tablatitulo">
                                <th colspan="17">LISTADO&nbsp;DE&nbsp;SUSTITUTOS&nbsp;REGISTRADOS</th>
                            </tr>
                            <tr class="tablasubtitulo">
                                ...
                                <th align="center">Disponobilidad Laboral</th>
...
public function getStrDetallePersona()
        {
            ...
            $retval .= '<fieldset class="fieldsetGrande">';
            $retval .= '<legend class="etiquetaborde">
                            SUSTITUTOS<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">LISTADO SUSTITUTOS<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">DETALLE SUSTITUTOS
                        </legend>
                       ';
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. SUSTITUTOS_URL .'sustitutos.php">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" />REGRESAR LISTADO SUSTITUTOS|</a>
                                    <td>
                                </tr>
                                ';
               ...
               $retval .= '<tr class="listadofila0">
				 ...
				 $retval .= '<tr class="listadofila0">
                                ...
                                '; 	
				$retval .= '<tr class="listadofila0">
                                    <th align="right" class="bienvenida">Observación teléfono:</th>
            ...
            $retval .= '<tr class="listadofila0">
             ...
             $retval .= '<tr class="listadofila0">
                                ...
                                '; 	                                       
			 $retval .= '<tr class="listadofila0">
                                    <th align="right" class="bienvenida">Tipo Federacion:</th>
