...
///////////////////////////////////////////////////////////
		...
		$thorario= new clThorario();
          ...
          $retval  = '<script type="text/JavaScript" src="' . HOST .NAME. '/jquery/jquery.validate.js"></script>
                        ...
                        <script>
                            $(document).ready(function(){
                                    ...
                                    $("#lsTdiscapacidad option:selected").each(function () {
                                            ...
                                            $.post( "'. DISCAPACIDADS_URL.'discapacidads.php", { btnBuscar: "pafectadas",
								  ...
								  $("#lsPafectadas").change(function () {
                                    $("#lsPafectadas option:selected").each(function () {
                                            ...
                                            $.post( "'. DISCAPACIDADS_URL.'discapacidads.php", { btnBuscar: "tnivelavance",
								...
								$("#lsTdiscapacidad").change(function() 
	                 				{
								  		if($(this).val() == "8" || $(this).val() == "7" || $(this).val() == "5" ) 
										  	{
											...
											else 
											{
												...
												if($(this).val() == "1" || $(this).val() == "3" || $(this).val() == "4" || $(this).val() == "2" || $(this).val() == "6") 
												  	{
									...
									$("#lsPafectadas").change(function() 
	                 				{
								  		if($(this).val() == "1" || $(this).val() == "2" || $(this).val() == "21" || $(this).val() == "6" || $(this).val() == "7" || $(this).val() == "0" || $(this).val() == "23" || $(this).val() == "22") 
										  	{
            ...
            $retval .= '<form id="frmdiscapacidads" action="'. DISCAPACIDADS_URL.'discapacidads.php" method="POST">';

           $Regresar = "regresar('". DISCAPACIDADS_URL. "discapacidads.php')";
...
<table width="100%" border="0" align="center" cellpadding="1">
        ...
        public function getStrIngresar() {
            ...
            if($query->getStrSqlInsertUpdateDelete()){
                ...
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s', '%s', '%s', '%s');", $_SESSION["usuario"]["cuenta"], 'GUARDAR', 'tusuario_discapacidad', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
       ...
       public function getStrListar()
        {
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= 	'<td align="center"><div class="vtip" title="ACTUALIZAR TIPO DISCAPACIDAD <br> [ codigo = '.$rst["id_usuario_discapacidad"] .' ]">';
                    $retval .=  '<a href="'. DISCAPACIDADS_URL .'discapacidads.php?btnActualizar=Actualizar&strCodigo='. $rst["id_usuario_discapacidad"] .'"><img src="'. IMAGENES_PATH .'/actualizar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="ELIMINAR TIPO DISCAPACIDAD <br> [codigo = '.$rst["id_usuario_discapacidad"] .' ]">';
                    $retval .=  '<a href="'.  DISCAPACIDADS_URL .'discapacidads.php?btnEliminar=Eliminar&strCodigo='. $rst["id_usuario_discapacidad"] .'" onclick="return confirmar()"><img src="'. IMAGENES_PATH .'/eliminar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="DETALLE TIPO DISCAPACIDAD<br> [ codigo = '.$rst["id_usuario_discapacidad"] .' ]">';
                    $retval .=  '<a href="'.  DISCAPACIDADS_URL .'discapacidads.php?btnDetalle=Detalle&strCodigo='. $rst["id_usuario_discapacidad"] .'"><img src="'. IMAGENES_PATH .'/detalle.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= '</tr>';
                    $i = 1 - $i;
                endforeach;
            ...
            $paginacion->setStrNombrePagina("discapacidads/discapacidads.php");
 ...
 public function getStrEliminar() 
           ...
           if($query->getStrSqlInsertUpdateDelete())
            {
                //Nombre Procedimientos Almacenados [Auditoria]
                $descripcion = 'TDiscapacidad = [ '.$this->getStrTdiscapacidad().' ] PAfectadas = [ '. $this->getStrPafectadas().' ] ';
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s', '%s', '%s', '%s');", $_SESSION["usuario"]["cuenta"], 'ELIMINAR', 'tusuario_discapacidad', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
                $query->getStrSqlInsertUpdateDelete();
                $resultado = true;
	...
	public function getStrActualizar() 
	{
			$query = new clQuery();
            $resultado = false;		
			 $ProcedimientoAlmacenado = sprintf("CALL spactualizardiscapacidads('%s','%s','%s','%s','%s','%s','%s','%s','%s',
			'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');",
            $this->getStrCodigo(),$this->getStrTdiscapacidad(),$this->getStrPafectadas(), $this->getStrTnivelavance(),
            $this->getStrObservaciones(),$this->getStrOdiscapacidad(),$this->getStrDiagnostico(),$this->getStrObservacionorigen(),$this->getStrTporcentaje(),
			$this->getStrFechaIngreso(),$this->getStrTayuda(),$this->getStrTayudaeconomica(),$this->getStrEstadod(),
            ...
            if($query->getStrSqlInsertUpdateDelete()){
                //Nombre Procedimientos Almacenados [Auditoria]
                $descripcion = 'TDiscapacidad = [ '.$this->getStrTdiscapacidad().' ] PAfectadas = [ '. $this->getStrPafectadas().' ] ';
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s', '%s', '%s', '%s');", $_SESSION["usuario"]["cuenta"], 'ACTUALIZAR', 'tusuario_discapacidad', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
                $query->getStrSqlInsertUpdateDelete();
                $resultado = true;
 			}
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. DISCAPACIDADS_URL.'discapacidads.php?btnNuevo=Nuevo&strCodigo='.$v.'">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" />REGRESAR LISTADO DISCAPACIDAD|</a>
                                    <td>
                                </tr>
                                ';
