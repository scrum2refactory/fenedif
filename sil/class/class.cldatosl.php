...
//////////////////////////valor a////////////////////////////////////
       ...
       public function getStrFormulario()
		...
		$relacion = new clTqgarante();
            ...
            $retval .= '<br><br><br><br>
            	...
            	$retval .= '<form id="frmdatosl" action="'.DATOSL_URL.'datosl.php" method="POST">';

             	$Regresar = "regresar('".DATOSL_URL . "datosl.php')";
  ...
  <table width="100%" border="0" align="center" cellpadding="1">
                            <tr>
                                <td colspan="4" align="center" class="tablatitulo">SITUACIÓN SOCIO LABORAL</td>
                            </tr>                           
                            <tr class="formulariofila1">
 ...
 <table width="100%" border="0" align="center" cellpadding="1">
        ...
        public function getStrIngresar() {
            ...
            if($query->getStrSqlInsertUpdateDelete()){
                ...
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s', '%s', '%s', '%s');", $_SESSION["usuario"]["cuenta"], 'GUARDAR', 'tdatosl', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
 ...
 public function getStrListar()
        {
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= 	'<td align="center"><div class="vtip" title="ACTUALIZAR DATOS LABORALES<br> [ codigo = '.$rst["tdatosl_id"] .' ]">';
                    $retval .=  '<a href="'.DATOSL_URL.'datosl.php?btnActualizar=Actualizar&strCodigo='. $rst["tdatosl_id"] .'"><img src="'. IMAGENES_PATH .'/actualizar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="ELIMINAR DATOS LABORALES<br> [codigo = '.$rst["tdatosl_id"] .' ]">';
                    $retval .=  '<a href="'.DATOSL_URL.'datosl.php?btnEliminar=Eliminar&strCodigo='. $rst["tdatosl_id"] .'" onclick="return confirmar()"><img src="'. IMAGENES_PATH .'/eliminar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="DETALLE DATOS LABORALES <br> [ codigo = '.$rst["tdatosl_id"] .' ]">';
                    $retval .=  '<a href="'.DATOSL_URL.'datosl.php?btnDetalle=Detalle&strCodigo='. $rst["tdatosl_id"] .'"><img src="'. IMAGENES_PATH .'/detalle.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= '</tr>';
                    $i = 1 - $i;
                endforeach;
            ...
            $paginacion->setStrNombrePagina("datosl/datosl.php");
...
public function getStrDetallePersona()
        {
            ...
            $retval .= '<fieldset class="fieldsetGrande">';
            $retval .= '<legend class="etiquetaborde">
                            DATOS LABORALES<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">LISTADO DATOS LABORALES<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">DETALLE DATOS LABORALES
                        </legend>
                       ';
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. DATOSL_URL .'datosl.php?btnNuevo=Nuevo&strCodigo='.$v.'">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" />REGRESAR LISTADO DATOS LABORALES|</a>
                                    <td>
                                </tr>
                                ';
