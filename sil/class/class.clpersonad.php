...
//////////////////////////////////////////////////////////////////
		...
		$thorario= new clThorario();
          ...
          $retval  = '<script type="text/JavaScript" src="' . HOST .NAME. '/jquery/jquery.validate.js"></script>
            ...
            $retval .= '<form id="frmpersonad" action="'. PERSONAD_URL.'personad.php" method="POST">';

           $Regresar = "regresar('".PERSONAD_URL. "personad.php')";
            ...
            $retval .= '
                        <table width="100%" border="0" align="center" cellpadding="1">
                           ...
                           <tr class="formulariofila1">
                            	<td align="right"><b>Parentezco:&nbsp;</b></td>
	                             	<td align="left">                                    
...
<table width="100%" border="0" align="center" cellpadding="1">
        ...
        public function getStrIngresar() {
            ...
            if($query->getStrSqlInsertUpdateDelete()){
                ...
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s', '%s', '%s', '%s');", $_SESSION["usuario"]["cuenta"], 'G', 'personad', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
       ...
       public function getStrListar()
        {
            ...
            $retval .= '
                        <table border="0" width="100%" cellpadding="1" cellspacing="1" align="center">
                            <tr class="tablatitulo">
                                <th colspan="11">LISTADO PARIENTES CON DISCAPACIDA </th>
                            </tr>
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
					...
					$retval .= 	'<td align="center"><div class="vtip" title="Actualizar <br> [ codigo = '.$rst["personad_id"] .' ]">';
                    $retval .=  '<a href="'.PERSONAD_URL .'personad.php?btnActualizar=Actualizar&strCodigo='. $rst["personad_id"] .'"><img src="'. IMAGENES_PATH .'/actualizar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="Eliminar <br> [codigo = '.$rst["personad_id"] .' ]">';
                    $retval .=  '<a href="'.PERSONAD_URL .'personad.php?btnEliminar=Eliminar&strCodigo='. $rst["personad_id"] .'" onclick="return confirmar()"><img src="'. IMAGENES_PATH .'/eliminar.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= 	'<td align="center"><div class="vtip" title="Detalle Centro Formativo <br> [ codigo = '.$rst["personad_id"] .' ]">';
                    $retval .=  '<a href="'.PERSONAD_URL .'personad.php?btnDetalle=Detalle&strCodigo='. $rst["personad_id"] .'"><img src="'. IMAGENES_PATH .'/detalle.png" title="" width="16px" height="16px"  border="0" /></a>';
                    $retval .= 	'</div></td>';
                    $retval .= '</tr>';
                    $i = 1 - $i;
                endforeach;
            ...
            $paginacion->setStrNombrePagina("personad/personad.php");
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. PERSONAD_URL.'personad.php?btnNuevo=Nuevo&strCodigo='.$v.'">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" />REGRESAR LISTADO DISCAPACIDAD|</a>
                                    <td>
                                </tr>
                                ';
