...
///////////////////////////////////////////////////////////////////		
        ...
        {            
          ...
          $retval  = '<script type="text/JavaScript" src="' . HOST .NAME. '/jquery/jquery.validate.js"></script>
                            ...
                            $(document).ready(function(){
                                    ...
                                    $(\'#frmninos\').validate({
                                            ...
                                            messages:{
                                                ...
                                                strIdentificaciont: { required: "<span class=\'resultadoincorrecto\'>* Requerido</span>"},
                                    ...
                                    $("#lsProvincia option:selected").each(function () {
                                            ...
                                            $.post( "'. NINOS_URL .'ninos.php", { btnBuscar: "Canton",
                                    ...
                                    $("#lsCanton option:selected").each(function () {
                                            var canton = $(this).val();
                                            $.post( "'. NINOS_URL .'ninos.php", { btnBuscar: "Parroquia",
            ...
            $retval .= '<form id="frmninos" action="'. NINOS_URL .'ninos.php" method="POST">';

            $Regresar = "regresar('". NINOS_URL . "ninos.php')";

            $retval .= '<fieldset class="fieldsetPequeno">';
            $retval .= '<legend class="etiquetaborde">
                            NIÑOS Y ADOLESCENTES <img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">LISTADO NIÑOS Y ADOLESCENTES<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;"> '. $this->getStrEtiqueta() .'
                          </legend>
                       ';
            $NHC = "";		   
            $retval .= '
                        <table width="100%" border="0" align="center" cellpadding="1">
                            <tr>
							 ...
							 <tr class="formulariofila1">
							  	<td align="right"><b>Tipo de Identificación:&nbsp;</b></td>
	                             	<td align="left">                                    
  ...
  <table width="100%" border="0" align="center" cellpadding="1">
                            <tr>
                                <td colspan="4" align="center" class="tablatitulo">DIRECCIÓN DEL NIÑOS Y ADOLESCENTES</td>
                            </tr>
 ...
 public function getStrEliminar() 
        {
            ...
            $resultado = false;
            //Nombre Procedimientos Almacenados
            $ProcedimientoAlmacenado = sprintf("CALL speliminarninos('%s');", $this->getStrCodigo());
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
           ...
           if($query->getStrSqlInsertUpdateDelete()){
                ...
                $ProcedimientoAlmacenado = sprintf("CALL spauditoria('%s', '%s', '%s', '%s');", $_SESSION["usuario"]["cuenta"], 'E', 'Niños Tusuario', $descripcion);
                $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
                $query->getStrSqlInsertUpdateDelete();
                $resultado = true;
            }
...
public function getStrBuscarr() 
	{
            ...
            $ProcedimientoAlmacenado = sprintf("CALL spbidentificador('%d','%d');","$cf","$me");
			$query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
       ...
       public function getStrListar()
        {
			...
			$valor="1";
            $ProcedimientoAlmacenado = sprintf("CALL sptotalninos('%s','%s');", $sucursal,$valor);
            $query->setStrProcedimientoAlmacenado($ProcedimientoAlmacenado);
            ...
            $retval .= '<legend class="etiquetaborde">
                            NIÑOS Y ADOLESCENTES<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">LISTADO NIÑOS Y ADOLESCENTES</legend>
                       ';
            $retval .= '
                        <table border="0" width="100%" cellpadding="1" cellspacing="1" align="center">
                            <tr>
                                <td colspan="14" align="center"><div class="vtip" title="Ingreso<br> [NUEVO NIÑOS Y ADOLESCENTES]">
                                    <a href="'.NINOS_URL.'ninos.php?btnNuevo=Nuevo">| <img src="'. IMAGENES_PATH .'/rptstocksucursal.png" title="" width="16px" height="16px"  border="0" /><img src="'. IMAGENES_PATH .'/nuevo.png" title="" width="16px" height="16px"  border="0" />NUEVO NIÑOS Y ADOLESCENTES |</a>
                                </div><td>
                            </tr>';
                            $paginacion->setStrNombrePagina("ninos/ninos.php");
            				$retval .= '<tr><td colspan="30" align="center">'. $paginacion->getStrPaginacion() .'</td></tr>
                            <tr class="tablatitulo">
                                <th colspan="17">LISTADO&nbsp;DE&nbsp;NIÑOS Y ADOLESCENTES&nbsp;REGISTRADOS</th>
                            </tr>
                            <tr class="tablasubtitulo">
                                ...
                                <th align="center">Parientes Discapacidad</th>
            ...
            if( count($resultado) > 0 )
            {
                ...
                foreach( $resultado as $rst):
                   ...
                   $retval .= 	'<td align="center"><div class="vtip" title="Parientes Discapacidad <br> [ codigo = '.$rst["id_usuario"] .' ]">';
                    ...
                    $retval .= 	'<td align="center"><div class="vtip" title="DETALLE NIÑOS Y ADOLESCENTES <br> [ codigo = '.$rst["id_usuario"] .' ]">';
...
public function getStrDetallePersona()
        {
            ...
            $retval .= '<fieldset class="fieldsetGrande">';
            $retval .= '<legend class="etiquetaborde">
                            NIÑOS Y ADOLESCENTES<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">LISTADO NIÑOS Y ADOLESCENTESs<img src="'. IMAGENES_PATH .'/siguiente.png" style="border: 0px none;">DETALLE NIÑOS Y ADOLESCENTES
                        </legend>
                       ';
                ...
                foreach( $resultado as $rst):
                    ...
                    $retval .= '<tr>
                                    <td colspan="2" align="center">
                                        <a href="'. NINOS_URL .'ninos.php">| <img src="'. IMAGENES_PATH .'/atras.png" title="Regresar" width="16px" height="16px"  border="0" />REGRESAR LISTADO NIÑOS Y ADOLESCENTES|</a>
                                    <td>
                                </tr>
                                ';
                    
                    $retval .= '<tr class="tablatitulo">
                                    <th colspan="2">DETALLE&nbsp;NIÑOS Y ADOLESCENTES;REGISTRADO</th>
                                </tr>
                                ';
                   ...
                   $retval .= '<tr class="listadofila0">
                    ...
                    $retval .= '<tr class="listadofila0">
					 ...
					 $retval .= '<tr class="listadofila0">
                                ...
                                ';  	
					 $retval .= '<tr class="listadofila0">
                                    <th align="right" class="bienvenida">Número de hijos:</th>
