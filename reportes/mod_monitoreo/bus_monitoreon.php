...
?>
<br />
<div class="titulo"><h6>MONITOREO NIÑOS ADOLESCENTES</h6></div>
<div id="centercontent">
<div align="center">
<table>
<td>
<form action="bus_monitoreon.php">
...
switch($_REQUEST["busqueda"])
{
	...
	<a target="_blank" href="../pdf/list_usuarion_todos.php?p1='.$sucursal_id.'&p2='.$estado.'
	&p3='.$ini.'
	&p4='.$fin.'
...
asociacion.asociacion_nombre,etnia.etnia_nombre,sucursal.sucursal_nombre
FROM
	tusuario
left join
...
where 
tusuario.tusuario_id='1' and tusuario.id_sucursal='$sucursal_id' and tusuario.estado='$estado' and tusuario.fecha_ingreso>='$ini' and tusuario.fecha_ingreso<='$fin '
...
left join
	sucursal on tusuario.id_sucursal=sucursal.sucursal_id
where 
tusuario.tusuario_id='1'and tusuario.id_sucursal='$sucursal_id' and tusuario.estado='$estado' and tusuario.fecha_ingreso>='$ini' and tusuario.fecha_ingreso<='$fin '"; //Cuento el total de registros
				...
				for($i=1; $i<$noPaginas+1; $i++)
				 { //Imprimo las páginas
        			...
        			echo "<font color=#FF0000><b>$i</b></font>"; //A la página actual no le pongo link
        					...
        					echo "<a href=\"bus_monitoreon.php?busqueda=todos&sucursal_id=".$sucursal_id."
        					&estado=".$estado."
        					&ini=".$ini."
        					&fin=".$fin."
...
?>	
	...
	case'sucursal':
		...
		$fin=$_REQUEST["fin"];
	echo '<td><p class="centrado">
	<a target="_blank" href="../pdf/list_usuarion_sucursal.php?p1='.$sucursal_id.'
...
left join
	sucursal on tusuario.id_sucursal=sucursal.sucursal_id
where 
tusuario.tusuario_id='1'and tusuario.id_sucursal='$sucursal_id'
		 LIMIT ".($pagina-1)*$noRegistros.",$noRegistros");
		$num_agrup = mysql_num_rows($sel_agrup);
		echo'<br>';echo'<br>';echo'<br>';
...
left join
	sucursal on tusuario.id_sucursal=sucursal.sucursal_id
where 
tusuario.tusuario_id='1'and tusuario.id_sucursal='$sucursal_id'"; //Cuento el total de registros
				$result = mysql_query($sSQL);
				$row = mysql_fetch_array($result);
				$totalRegistros = $row["count(*)"]; //Almaceno el total en una variable
				...
				for($i=1; $i<$noPaginas+1; $i++)
				 { //Imprimo las páginas
        			...
        			echo "<font color=#FF0000><b>$i</b></font>"; //A la página actual no le pongo link
        					...
        					echo "<a href=\"bus_monitoreon.php?busqueda=sucursal&sucursal_id=".$sucursal_id."
...
?>	
	...
	case'estado':
		...
		$fin=$_REQUEST["fin"];
	echo '<td><p class="centrado">
	<a target="_blank" href="../pdf/list_usuarion_estado.php?p2='.$estado.'
	" title="'.$id_excel.'"><img src="../imgs/excel_img.png" alt="'.$id_excel.'" /></a>
...
left join
	sucursal on tusuario.id_sucursal=sucursal.sucursal_id
where 
tusuario.tusuario_id='1'and tusuario.estado='$estado'
		 LIMIT ".($pagina-1)*$noRegistros.",$noRegistros");
		$num_agrup = mysql_num_rows($sel_agrup);
		echo'<br>';echo'<br>';echo'<br>';
		$sSQL = "SELECT count(*) FROM
...
left join
	sucursal on tusuario.id_sucursal=sucursal.sucursal_id
where 
tusuario.tusuario_id='1'and tusuario.estado='$estado'"; //Cuento el total de registros
				$result = mysql_query($sSQL);
				$row = mysql_fetch_array($result);
				$totalRegistros = $row["count(*)"]; //Almaceno el total en una variable
				...
				for($i=1; $i<$noPaginas+1; $i++)
				 { //Imprimo las páginas
        			...
        			echo "<font color=#FF0000><b>$i</b></font>"; //A la página actual no le pongo link
        					...
        					echo "<a href=\"bus_monitoreon.php?busqueda=estado&estado=".$estado."
...
?>	
	...
	case'rangofechas':
		...
		$fin=$_REQUEST["ffin"];
	echo '<td><p class="centrado">
	<a target="_blank" href="../pdf/list_usuarion_fechas.php?p3='.$ini.'
	&p4='.$fin.'
	" title="'.$id_excel.'"><img src="../imgs/excel_img.png" alt="'.$id_excel.'" /></a>
...
left join
	sucursal on tusuario.id_sucursal=sucursal.sucursal_id
where 
tusuario.tusuario_id='1' and tusuario.fecha_ingreso>='$ini' and tusuario.fecha_ingreso<='$fin '
		 LIMIT ".($pagina-1)*$noRegistros.",$noRegistros");
		$num_agrup = mysql_num_rows($sel_agrup);
		echo'<br>';echo'<br>';echo'<br>';
		$sSQL = "SELECT count(*) FROM
...
left join
	sucursal on tusuario.id_sucursal=sucursal.sucursal_id
where 
tusuario.tusuario_id='1' and tusuario.fecha_ingreso>='$ini' and tusuario.fecha_ingreso<='$fin '"; //Cuento el total de registros
				$result = mysql_query($sSQL);
				$row = mysql_fetch_array($result);
				$totalRegistros = $row["count(*)"]; //Almaceno el total en una variable
				...
				for($i=1; $i<$noPaginas+1; $i++)
				 { //Imprimo las páginas
        			...
        			echo "<font color=#FF0000><b>$i</b></font>"; //A la página actual no le pongo link
        					...
        					echo "<a href=\"bus_monitoreon.php?busqueda=rangofechas&ini1=".$ini1."
        					&ffin=".$ffin."
        					&pagina=".$i."\">  <font color=#000080><b>$i</b></font></a>";
						$vehiculo="";
				 }	
...
{
	echo '<td><p class="centrado">
	<a target="_blank" href="../pdf/list_usuarion.php" title="'.$id_excel.'"><img src="../imgs/excel_img.png" alt="'.$id_excel.'" /></a>
	</a></p></td>';
				...
				for($i=1; $i<$noPaginas+1; $i++)
				 { //Imprimo las páginas
        			...
        			echo "<font color=#FF0000><b>$i</b></font>"; //A la página actual no le pongo link
        					...
        					echo "<a href=\"bus_monitoreon.php?pagina=".$i."\">  <font color=#000080><b>$i</b></font></a>";
						$vehiculo="";
				 }	
?>	
					<table width="500" align="center" class="tabla">
