...
header("content-disposition: attachment;filename=list_usuariop_todos.xls");
?>
<HTML LANG="es">
...
where 
tusuario.tusuario_id='2' and tusuario.id_sucursal='$sucursal_id' and tusuario.estado='$estado' and tusuario.fecha_ingreso>='$ini' 
and tusuario.fecha_ingreso<='$fin ' order by apellido_paterno
";
