...
header("content-disposition: attachment;filename=list_usuarion_todos.xls");
?>
<HTML LANG="es">
...
,$row["id_usuario"],$row["identificacion"],$row["apellido_paterno"],$row["genero_nombre"],$row["estadocivil_nombre"],
...
$row["adaptacion"],$row["tipo_adaptacion"],$row["sucursal_nombre"]
